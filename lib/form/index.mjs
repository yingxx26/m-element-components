import { defineComponent as Cn, ref as Jt, watch as Tn, nextTick as Dn, onMounted as In, resolveComponent as ae, openBlock as ct, createElementBlock as wt, createBlock as xt, mergeProps as Wt, withCtx as Nt, Fragment as ie, renderList as Ie, resolveDynamicComponent as le, createCommentVNode as Bt, renderSlot as se, createVNode as Pn } from "vue";
...
var lr = ir, sr = typeof Xt == "object" && Xt && Xt.Object === Object && Xt, tn = sr, ur = tn, fr = typeof self == "object" && self && self.Object === Object && self, cr = ur || fr || Function("return this")(), pt = cr, dr = pt, vr = dr.Symbol, me = vr, Pe = me, en = Object.prototype, pr = en.hasOwnProperty, hr = en.toString, Qt = Pe ? Pe.toStringTag : void 0;
function mr(P) {
...
var xr = Er, Re = me, Sr = gr, Cr = xr, Tr = "[object Null]", Dr = "[object Undefined]", Me = Re ? Re.toStringTag : void 0;
function Ir(P) {
...
var zt = Pr, Rr = te, Mr = zt, Nr = "[object AsyncFunction]", Br = "[object Function]", Fr = "[object GeneratorFunction]", Or = "[object Proxy]";
function Lr(P) {
  if (!Mr(P))
    return !1;
  var L = Rr(P);
...
var rn = Yr, zr = nn, Gr = Ur, Vr = zt, Kr = rn, Jr = /[\\^$.*+?()[\]{}|]/g, Wr = /^\[object .+?Constructor\]$/, Xr = Function.prototype, Zr = Object.prototype, kr = Xr.toString, qr = Zr.hasOwnProperty, _r = RegExp(
...
var mo = ho, go = ee, Ao = "__lodash_hash_undefined__", yo = Object.prototype, Eo = yo.hasOwnProperty;
function xo(P) {
  var L = this.__data__;
  if (go) {
    var o = L[P];
...
var ha = pa, ma = _t, ga = er, Aa = rr, ya = ar, Ea = lr, xa = ha;
function $t(P) {
...
var Gt = Ua, wa = te, Qa = Gt, Ya = "[object Arguments]";
function za(P) {
  return Qa(P) && wa(P) == Ya;
}
var Ga = za, Le = Ga, Va = Gt, ln = Object.prototype, Ka = ln.hasOwnProperty, Ja = ln.propertyIsEnumerable, Wa = Le(function() {
  return arguments;
}()) ? Le : function(P) {
...
var qa = ka;
(function(P, L) {
  var o = pt, n = qa, t = L && !L.nodeType && L, e = t && !0 && P && !P.nodeType && P, i = e && e.exports === t, r = i ? o.Buffer : void 0, a = r ? r.isBuffer : void 0, c = a || n;
  P.exports = c;
})(kt, kt.exports);
...
var ye = Li, Yt = { exports: {} };
(function(P, L) {
  var o = tn, n = L && !L.nodeType && L, t = n && !0 && P && !P.nodeType && P, e = t && t.exports === n, i = e && o.process, r = function() {
    try {
...
var $i = Oi, Hi = ye, $e = Yt.exports, He = $e && $e.isTypedArray, bi = He ? Hi(He) : $i, ji = bi, Ui = ja, wi = Xa, Qi = Ae, Yi = kt.exports, zi = ni, Gi = ji, Vi = Object.prototype, Ki = Vi.hasOwnProperty;
function Ji(P, L) {
  var o = Qi(P), n = !o && wi(P), t = !o && !n && Yi(P), e = !o && !n && !t && Gi(P), i = o || n || t || e, r = i ? Ui(P.length, String) : [], a = r.length;
  for (var c in P)
    (L || Ki.call(P, c)) && !(i && (c == "length" || t && (c == "offset" || c == "parent") || e && (c == "buffer" || c == "byteLength" || c == "byteOffset") || zi(c, a))) && r.push(c);
  return r;
}
...
var Al = gl, yl = zt, El = Ee, xl = Al, Sl = Object.prototype, Cl = Sl.hasOwnProperty;
function Tl(P) {
  if (!yl(P))
    return xl(P);
  var L = El(P), o = [];
...
var dn = jl, Ul = bl, wl = dn, Ql = Object.prototype, Yl = Ql.propertyIsEnumerable, be = Object.getOwnPropertySymbols, zl = be ? function(P) {
  return P == null ? [] : (P = Object(P), Ul(be(P), function(L) {
    return Yl.call(P, L);
  }));
...
var mn = us, fs = mn, cs = Ce, ds = xe;
function vs(P) {
  return fs(P, ds, cs);
}
var ps = vs, hs = mn, ms = hn, gs = Se;
function As(P) {
  return hs(P, gs, ms);
}
var ys = As, Es = Ct, xs = pt, Ss = Es(xs, "DataView"), Cs = Ss, Ts = Ct, Ds = pt, Is = Ts(Ds, "Promise"), Ps = Is, Rs = Ct, Ms = pt, Ns = Rs(Ms, "Set"), Bs = Ns, Fs = Ct, Os = pt, Ls = Fs(Os, "WeakMap"), $s = Ls, ce = Cs, de = ge, ve = Ps, pe = Bs, he = $s, gn = te, Ht = rn, je = "[object Map]", Hs = "[object Object]", Ue = "[object Promise]", we = "[object Set]", Qe = "[object WeakMap]", Ye = "[object DataView]", bs = Ht(ce), js = Ht(de), Us = Ht(ve), ws = Ht(pe), Qs = Ht(he), St = gn;
(ce && St(new ce(new ArrayBuffer(1))) != Ye || de && St(new de()) != je || ve && St(ve.resolve()) != Ue || pe && St(new pe()) != we || he && St(new he()) != Qe) && (St = function(P) {
  var L = gn(P), o = L == Hs ? P.constructor : void 0, n = o ? Ht(o) : "";
  if (n)
    switch (n) {
      case bs:
        return Ye;
...
function Xs(P) {
  ...
  return new ze(L).set(new ze(P)), L;
}
var De = Xs, Zs = De;
function ks(P, L) {
...
var eu = tu, Ge = me, Ve = Ge ? Ge.prototype : void 0, Ke = Ve ? Ve.valueOf : void 0;
function nu(P) {
...
var Fu = Bu, Ou = zt, Je = Object.create, Lu = function() {
  function P() {
  }
  return function(L) {
    if (!Ou(L))
...
var wu = Uu, Qu = Te, Yu = Gt, zu = "[object Map]";
function Gu(P) {
  return Yu(P) && Qu(P) == zu;
}
var Vu = Gu, Ku = Vu, Ju = ye, We = Yt.exports, Xe = We && We.isMap, Wu = Xe ? Ju(Xe) : Ku, Xu = Wu, Zu = Te, ku = Gt, qu = "[object Set]";
function _u(P) {
  return ku(P) && Zu(P) == qu;
}
var tf = _u, ef = tf, nf = ye, Ze = Yt.exports, ke = Ze && Ze.isSet, rf = ke ? nf(ke) : ef, of = rf, af = Sa, lf = Ta, sf = an, uf = ml, ff = Ol, cf = fe.exports, df = $l, vf = Jl, pf = is, hf = ps, mf = ys, gf = Te, Af = Vs, yf = Fu, Ef = wu, xf = Ae, Sf = kt.exports, Cf = Xu, Tf = zt, Df = of, If = xe, Pf = Se, Rf = 1, Mf = 2, Nf = 4, An = "[object Arguments]", Bf = "[object Array]", Ff = "[object Boolean]", Of = "[object Date]", Lf = "[object Error]", yn = "[object Function]", $f = "[object GeneratorFunction]", Hf = "[object Map]", bf = "[object Number]", En = "[object Object]", jf = "[object RegExp]", Uf = "[object Set]", wf = "[object String]", Qf = "[object Symbol]", Yf = "[object WeakMap]", zf = "[object ArrayBuffer]", Gf = "[object DataView]", Vf = "[object Float32Array]", Kf = "[object Float64Array]", Jf = "[object Int8Array]", Wf = "[object Int16Array]", Xf = "[object Int32Array]", Zf = "[object Uint8Array]", kf = "[object Uint8ClampedArray]", qf = "[object Uint16Array]", _f = "[object Uint32Array]", rt = {};
...
function Zt(P, L, o, n, t, e) {
  ...
  var l = c ? a ? mf : hf : a ? Pf : If, u = g ? void 0 : l(P);
  return lf(u || P, function(s, p) {
    u && (p = s, s = P[p]), sf(i, p, Zt(s, L, o, p, P, e));
  }), i;
}
...
`, ""]), o.exports = n;
      ...
      function(o, n, t) {
        var e = t(5), i = t(43), r = t(8), a = t(36), c = t(109), g = t(53), d = t(110), h = t(37), f = t(111), l = t(13), u = t(41), s = t(83), p = t(34), v = t(102), m = t(66), y = t(115), A = t(116), x = t(117).set, S = t(176), D = t(119), I = t(177), C = t(85), E = t(120), T = t(42), R = t(101), N = t(10), M = t(86), B = N("species"), F = "Promise", O = T.get, b = T.set, $ = T.getterFor(F), H = c, j = r.TypeError, V = r.document, U = r.process, W = a("fetch"), K = C.f, w = K, Y = p(U) == "process", J = !!(V && V.createEvent && r.dispatchEvent), k = "unhandledrejection", nt = "rejectionhandled", at = 0, dt = 1, Vt = 2, st = 1, bt = 2, Tt, ut, ht, Dt, mt = R(F, function() {
          ...
          if (!Q.notified) {
            ...
            S(function() {
              for (var G = Q.value, z = Q.state == dt, Z = 0; tt.length > Z; ) {
                var _ = tt[Z++], et = z ? _.ok : _.fail, it = _.resolve, ft = _.reject, vt = _.domain, lt, Ut, Kt;
                try {
                  et ? (z || (Q.rejection === bt && Mt(X, Q), Q.rejection = st), et === !0 ? lt = G : (vt && vt.enter(), lt = et(G), vt && (vt.exit(), Kt = !0)), lt === _.promise ? ft(j("Promise-chain cycle")) : (Ut = It(lt)) ? Ut.call(lt, it, ft) : it(lt)) : ft(G);
                } catch (Sn) {
                  vt && !Kt && vt.exit(), ft(Sn);
                }
              }
          ...
          Q.done || (Q.done = !0, tt && (Q = tt), Q.value = q, Q.state = Vt, yt(X, Q, !0));
        ...
        }, !i && typeof c == "function" && (Dt = c.prototype.then, g(c.prototype, "then", function(Q, q) {
          var tt = this;
      ...
      function(o, n, t) {
        var e = t(5), i = t(8), r = t(36), a = t(43), c = t(14), g = t(76), d = t(106), h = t(11), f = t(16), l = t(55), u = t(13), s = t(25), p = t(31), v = t(30), m = t(60), y = t(48), A = t(77), x = t(52), S = t(126), D = t(235), I = t(127), C = t(71), E = t(18), T = t(59), R = t(19), N = t(53), M = t(74), B = t(63), F = t(51), O = t(64), b = t(10), $ = t(93), H = t(12), j = t(37), V = t(42), U = t(32).forEach, W = B("hidden"), K = "Symbol", w = "prototype", Y = b("toPrimitive"), J = V.set, k = V.getterFor(K), nt = Object[w], at = i.Symbol, dt = r("JSON", "stringify"), Vt = C.f, st = E.f, bt = D.f, Tt = T.f, ut = M("symbols"), ht = M("op-symbols"), Dt = M("string-to-symbol-registry"), mt = M("symbol-to-string-registry"), oe = M("wks"), It = i.QObject, yt = !It || !It[w] || !It[w].findChild, Pt = c && h(function() {
          ...
          z === nt && Mt(ht, Z, _), s(z);
          var et = m(Z, !0);
          return s(_), f(ut, et) ? (_.enumerable ? (f(z, W) && z[W][et] && (z[W][et] = !1), _ = A(_, { enumerable: y(0, !1) })) : (f(z, W) || st(z, W, y(1, {})), z[W][et] = !0), Pt(z, et, _)) : st(z, et, _);
        }, gt = function(z, Z) {
          s(z);
          var _ = v(Z), et = x(_).concat(q(_));
          return U(et, function(it) {
            (!c || Et.call(_, it)) && Mt(z, it, _[it]);
          }), z;
        }, At = function(z, Z) {
          return Z === void 0 ? A(z) : gt(A(z), Z);
        }, Et = function(z) {
          var Z = m(z, !0), _ = Tt.call(this, Z);
        ...
        if (g || (at = function() {
          ...
          var z = !arguments.length || arguments[0] === void 0 ? void 0 : String(arguments[0]), Z = O(z), _ = function(et) {
            this === nt && _.call(ht, et), f(this, W) && f(this[W], Z) && (this[W][Z] = !1), Pt(this, Z, y(1, et));
          };
          return c && yt && Pt(nt, Z, { configurable: !0, set: _ }), jt(Z, z);
...
const ac = /* @__PURE__ */ Rn(xn.exports), ic = {
  key: 2,
  id: "editor"
}, lc = /* @__PURE__ */ Cn({
  __name: "index",
  ...
  setup(P, { expose: L, emit: o }) {
    const n = P, t = Jt(null), e = Jt(null), i = Jt(null), r = Jt();
    Tn(() => n.options, () => {
      a();
    }, { deep: !0 });
    const a = () => {
      if (n.options && n.options.length) {
        let A = {}, x = {};
        n.options.map((S) => {
          A[S.prop] = S.value, x[S.prop] = S.rules, S.type === "editor" && Dn(() => {
        ...
        }), t.value = qe(A), e.value = qe(x);
      }
    };
    L({
      resetFields: () => {
        var A;
        if ((A = i.value) == null || A.resetFields(), n.options && n.options.length) {
          let x = n.options.find((S) => S.type === "editor");
          r.value.txt.html(x.value);
        }
      },
    ...
    return In(() => {
      ...
      const S = ae("el-upload"), D = ae("el-form-item"), I = ae("el-form");
      return ct(), wt("div", null, [
        t.value ? (ct(), xt(I, Wt({
          key: 0,
          ref_key: "form",
          ref: i
          ...
          default: Nt(() => [
            (ct(!0), wt(ie, null, Ie(P.options, (C, E) => (ct(), wt(ie, { key: E }, [
              !C.children || (C == null ? void 0 : C.children.length) === 0 ? (ct(), xt(D, {
                key: 0,
                label: C.label,
                prop: C.prop
              }, {
                default: Nt(() => [
                  C.type !== "upload" && C.type !== "editor" ? (ct(), xt(le(`el-${C.type}`), Wt({
                    key: 0,
                    placeholder: C.placeholder
                  }, C.attrs, {
                    modelValue: t.value[C.prop],
                    "onUpdate:modelValue": (T) => t.value[C.prop] = T
                  }), null, 16, ["placeholder", "modelValue", "onUpdate:modelValue"])) : Bt("", !0),
                  C.type === "upload" ? (ct(), xt(S, Wt({ key: 1 }, C.uploadAttrs, {
                    "on-preview": h,
                    "on-remove": f,
                    "on-success": l,
                    "on-error": u,
                    ...
                    default: Nt(() => [
                      se(A.$slots, "uploadArea"),
                      se(A.$slots, "uploadTip")
                    ]),
                    _: 2
                  }, 1040, ["http-request"])) : Bt("", !0),
                  C.type === "editor" ? (ct(), wt("div", ic)) : Bt("", !0)
                ]),
                _: 2
              }, 1032, ["label", "prop"])) : Bt("", !0),
              C.children && (C == null ? void 0 : C.children.length) ? (ct(), xt(D, {
                key: 1,
                label: C.label,
                prop: C.prop
              }, {
                default: Nt(() => [
                  (ct(), xt(le(`el-${C.type}`), Wt({
                    placeholder: C.placeholder
                  }, C.attrs, {
                    modelValue: t.value[C.prop],
                    "onUpdate:modelValue": (T) => t.value[C.prop] = T
                    ...
                    default: Nt(() => [
                      (ct(!0), wt(ie, null, Ie(C.children, (T, R) => (ct(), xt(le(`el-${T.type}`), {
                        key: R,
                        label: T.label,
                        value: T.value
